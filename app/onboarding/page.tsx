...
// GHL booking widget — loads form_embed.js so the iframe auto-resizes via
// postMessage. Sans ce script, l'iframe reste figée à sa hauteur initiale et
// les créneaux du calendrier sont rognés en bas. Mirror du composant utilisé
// dans /portal — gardez les deux versions synchronisées si vous touchez à
// l'une.
